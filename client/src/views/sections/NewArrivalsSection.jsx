...
const NewArrivalsSection = () => {
  // Books data for New Arrivals section - Easy to add new books here
  const newArrivalBooks = [
    {
      ...
      discount: 17,
      rating: 4.6,
      cover: "/images/books/new-arrivals/book1.jpg", // Add your book images here
    ...
    },
    {
      ...
      discount: 18,
      rating: 4.8,
      cover: "/images/books/new-arrivals/book2.jpg",
    ...
    },
    {
      ...
      discount: 20,
      rating: 4.7,
      cover: "/images/books/new-arrivals/book3.jpg",
      arrivalDate: "New This Month"
    },
    {
      id: 4,
      ...
      discount: 15,
      rating: 4.9,
      cover: "/images/books/new-arrivals/book4.jpg",
      arrivalDate: "Fresh Arrival"
    },
    {
      id: 5,
      ...
      discount: 22,
      rating: 4.5,
      cover: "/images/books/new-arrivals/book5.jpg",
      arrivalDate: "Latest Release"
    },
    {
      id: 6,
      ...
      discount: 14,
      rating: 4.8,
      cover: "/images/books/new-arrivals/book6.jpg",
      arrivalDate: "Just In"
    }
  ...
  const scrollLeft = () => {
    const container = document.getElementById('new-arrivals-books');
    if (container) {
    ...
    <div className="flex-none w-48 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 cursor-pointer">
      <div className="relative">
        <img
          ...
          onError={(e) => {
            e.target.src = "https://via.placeholder.com/200x300/059669/white?text=New+Arrival";
          }}
        />
      ...
      <div className="p-4">
        ...
        <p className="text-green-600 text-xs mb-2 font-medium">{book.arrivalDate}</p>
